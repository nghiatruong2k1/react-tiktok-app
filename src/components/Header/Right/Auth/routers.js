...
export const routersLogin = [
    {
        ...
        path:"facebook",text:"Tiếp tục với Facebook",icon:IconBrandFacebook
    },{
        path:"google",text:"Tiếp tục với Google",icon:IconBrandGoogle
    },{
        path:"twitter",text:"Tiếp tục với Twitter",icon:IconBrandTwitter
    },{
        path:"apple",text:"Tiếp tục với Apple",icon:IconBrandApple
    },{
        path:"instagram",text:"Tiếp tục với Instagram",icon:IconBrandInstagram
    }
];
